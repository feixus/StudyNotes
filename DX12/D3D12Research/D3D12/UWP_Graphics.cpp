...
D3D12_CPU_DESCRIPTOR_HANDLE UWP_Graphics::GetDepthStencilView() const
{
...
void UWP_Graphics::BuildConstantBuffers()
{
	// constant buffer
...
void UWP_Graphics::BuildRootSignature()
{
...
void UWP_Graphics::BuildShaderAndInputLayout()
{
#if defined(_DEBUG)
	// shader debugging
...
void UWP_Graphics::BuildGeometry()
{
	{
		// vertex buffer
