...
void GraphicsBuffer::Create(Graphics* pGraphics, uint32_t size, bool cpuVisible)
{
...
void GraphicsBuffer::CreateInternal(ID3D12Device* pDevice, uint32_t elementStride, uint32_t elementCount, BufferUsage usage)
{
	Release();
...
void VertexBuffer::Create(Graphics* pGraphics, uint32_t elementStride, uint32_t elementCount, bool cpuVisible /*= false*/)
{
