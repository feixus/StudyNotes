...
public:
    ...
    void Execute(CommandContext& renderContext, const RGPassResource& resources)
    {
    ...
    {
        RG_STATIC_ASSERT(sizeof(ExecuteCallback) < 2048, "the execute callback exceeds the maximum size");
...
private:
    DECLARE_DELEGATE(ExecutePassDelegate, CommandContext&, const RGPassResource&);
