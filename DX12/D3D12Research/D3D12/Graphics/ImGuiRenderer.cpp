...
ImGuiRenderer::ImGuiRenderer(GraphicsDevice* pGraphicsDevice, WindowHandle window, uint32_t numBufferedFrames)
{
	...
	D3D12_CPU_DESCRIPTOR_HANDLE srvHandle = pGraphicsDevice->AllocateDescriptor<D3D12_SHADER_RESOURCE_VIEW_DESC>();
...
void ImGuiRenderer::Render(RGGraph& graph, const SceneView& sceneData, GraphicsTexture* pRenderTarget)
{
	...
	if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
	{
		...
		renderPlatformUI.Bind([=](CommandContext& context, const RGPassResource& /*resources*/)
			{
