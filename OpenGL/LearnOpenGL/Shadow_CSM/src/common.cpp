...
void Common::RenderCube_PNT(unsigned int& cubeVAO, unsigned int& cubeVBO)
{
...
void Common::RenderQuad(unsigned int& quadVAO, unsigned int& quadVBO)
{
    if (quadVAO == 0)
    {
        static const GLfloat vertex_positions[] = {
...
void Common::RenderQuadStrip(unsigned int& quadVAO, unsigned int& quadVBO)
{
    if (quadVAO == 0)
    {
        float quadVertices[] = {
