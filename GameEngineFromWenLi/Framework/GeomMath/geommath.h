...
namespace My
{
	...
	typedef struct Vector3Type
	{
		union {
			...
			swizzle<Vector2Type, 0, 1, 2> xyz;
			swizzle<Vector2Type, 1, 0, 2> yxz;
			swizzle<Vector2Type, 0, 2, 1> xzy;
			swizzle<Vector2Type, 2, 0, 1> zxy;
			swizzle<Vector2Type, 1, 2, 0> yzx;
			swizzle<Vector2Type, 2, 1, 0> zyx;
		};
