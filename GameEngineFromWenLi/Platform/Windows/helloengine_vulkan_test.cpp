...
/*
cl /EHsc /Z7 -I"%VULKAN_SDK%/Include" user32.lib gdi32.lib vulkan-1.lib helloengine_vulkan_test.cpp -std:c++20  /link /LIBPATH:"%VULKAN_SDK%/Lib"   

    debug: devenv /debug helloengine_vulkan_test.exe
*/