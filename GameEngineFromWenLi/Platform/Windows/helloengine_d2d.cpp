...
/*
debug in vs using x64 Native Tools Command Prompt for VS 2022
1. clang-cl -c -Z7 -o helloengine_d2d.obj helloengine_d2d.cpp
2. link -debug user32.lib ole32.lib d2d1.lib helloengine_d2d.obj
3. devenv /debug helloengine_d2d.exe
*/