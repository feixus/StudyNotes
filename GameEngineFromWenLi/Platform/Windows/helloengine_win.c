...
//compile with clang(game engine-08): clang -l user32.lib -o helloengine_win.exe helloengine_win.c

//compile with cl(game engine-09): cl user32.lib gdi32.lib helloengine_win.c
